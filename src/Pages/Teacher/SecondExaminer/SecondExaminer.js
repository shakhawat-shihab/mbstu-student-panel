                                                                ...
                                                                <td style={{ border: "1px solid black" }}>
                                                                    {
                                                                        editFinalMarks
                                                                            ?
                                                                            <input type='number' className=' w-50 text-center' defaultValue={x?.second_examiner_marks}
                                                                                {...register(`${x?.s_id}_second_examiner_marks`, { required: true })}
                                                                            />
                                                                            :
                                                                            <p>{x?.second_examiner_marks}</p>
                                                                    }
                                                                </td>
                                                            </tr>)
                                                        }
