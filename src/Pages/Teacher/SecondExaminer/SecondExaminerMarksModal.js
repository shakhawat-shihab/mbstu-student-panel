                                    ...
                                    <div className='mb-2'>
                                        <div className='mt-4 d-flex justify-content-between'>
                                            <div className='d-flex flex-column'>
                                                ...
                                                <span className='fw-bold'>Name of the Examiner: {props?.marks?.secondExaminer?.name}</span>
                                            </div>
                                ...
                                <tbody>
                                    {
                                        ...
                                        paginatedMarks?.map(x => {
                                            // console.log(x)
                                            return (
                                                <tr key={x?.s_id} style={{ border: "1px solid black", fontSize: "12px" }}>
                                                    <td style={{ border: "1px solid black" }} className='text-uppercase'>
                                                        {x?.id}
                                                    </td>
                                                    <td style={{ border: "1px solid black" }}>
                                                        {x?.studentProfileId?.firstName + ' ' + x?.studentProfileId?.lastName}
                                                    </td>
                                                    {
                            ...
                            <div className='mt-5 pt-5'>
                                <div className='container d-flex justify-content-between pe-4'>
                                    <div className="w-50 d-flex flex-column fw-bold">
                                        ...
                                        <span className=''>Signature of the Second Examiner</span>
                                        <span>Date: </span>
                                    </div>
