...
const AdmitCardModal = (props) => {
    ...
    const handleDownload = () => {
        ...
        html2canvas(selected, { useCORS: true }, { scale: '5' }).then((canvas) => {
            ...
            pdfDOC.save(`admit-card-${applicantId.toUpperCase()}.pdf`);
        });
    }
    return (
        <div>
                    ...
                    <div id="selectedPortion" className='pt-5 px-3 font-style-work-sans'>
                        <div className='px-4'>
                            <div className='row'>
                                ...
                                <div className="col-lg-9 ps-5 mt-2 font-style-work-sans">
                            ...
                            <div className='d-flex flex-column mb-3 ps-3 mt-3'>
