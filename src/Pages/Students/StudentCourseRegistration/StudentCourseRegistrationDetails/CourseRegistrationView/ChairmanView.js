...
const ChairmanView = (props) => {
    ...
    return (
        <div>
            {
                application?.isChairmanVerified || application?.chairmanMessage
                    ?
                    <div className='container shadow-lg py-4 px-5 my-4 rounded'>
                        <h2 className='text-center mb-5 fw-bold' style={{ color: "#3C3FED" }}>Chairman Approval</h2>
                        ...
                        {
                            application?.chairmanMessage != undefined &&
                            <div className="my-3" style={{ fontSize: "20px" }}>
                                <span className="fw-bold" style={{ color: "#3C3FED" }}>Chairman message: </span> <br />
                                <Form.Group className="mb-3 mt-2" controlId="exampleForm.ControlTextarea1">
                                    <Form.Control as="textarea" rows={3} value={application?.chairmanMessage} style={{ fontStyle: "italic", fontSize: "20px" }} />
                                </Form.Group>
                            </div>
                        }
                    ...
                    <div className=' d-flex justify-content-center align-items-center half-height' >
                        <h5 className='text-center fs-2 text-secondary my-4 fw-bold error-opacity' >Chairman has not approved application yet</h5>
                    </div>
            }
